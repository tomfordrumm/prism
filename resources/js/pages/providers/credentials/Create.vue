...
import { create, index, store } from '@/routes/provider-credentials';
...
<template>
    <Head title="Add provider credential" />

    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="flex flex-col gap-4 p-4">
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-xl font-semibold text-foreground">Add provider credential</h1>
                    <p class="text-sm text-muted-foreground">
                        Store encrypted API keys for your LLM providers.
                    </p>
                </div>
            ...
            <form class="space-y-4 rounded-lg border border-border bg-card p-4" @submit.prevent="submit">
                ...
                <div class="flex items-center gap-3">
                    <Button type="submit" :disabled="form.processing">Save credential</Button>
