...
interface AgentPayload {
    ...
    system_inline_content: string | null;
...
const modelParams = extractModelParams(props.agent.model_params);
...
const {
    ...
    initialData: {
        ...
        provider_credential_id: props.agent.provider_credential_id,
        model_name: props.agent.model_name,
        temperature: modelParams.temperature,
        max_tokens: modelParams.max_tokens,
        max_context_messages: props.agent.max_context_messages,
        system_prompt_mode: props.agent.system_prompt_mode,
        system_prompt_template_id: props.agent.system_prompt_template_id,
        system_prompt_version_id: props.agent.system_prompt_version_id,
        system_inline_content: props.agent.system_inline_content ?? '',
    },
});
...
const submit = () => {
    ...
    })).put(agentRoutes.update({ project: props.project.uuid, agent: props.agent.id }).url);
};
</script>
...
<template>
    <ProjectLayout :project="project" title-suffix="Edit Agent">
        <div class="flex items-center justify-between">
            <div class="flex items-center gap-3">
                ...
                <div>
                    <h2 class="text-xl font-semibold text-foreground">Edit Agent</h2>
